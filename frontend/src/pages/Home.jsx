    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-700">
                <PriceCard currentPrice={currentPrice} previousPrice={previousPrice} symbol={symbol} />
                <PredictionCard prediction={prediction} />
                <TradePanel symbol={symbol} currentPrice={currentPrice} onTradeSuccess={() => console.log('Trade success!')} />
            </div>
